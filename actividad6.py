palabras1 = input("ingresa una lista de palabras:  ")
palabras2 = input("ingresa una lista de palabras:  ")
palabras3 = input("ingresa una lista de palabras:  ")
letra_p = input("Indica tú letra: ")
